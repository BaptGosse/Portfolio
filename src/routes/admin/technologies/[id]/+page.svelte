...
<svelte:head>
	<title>Modifier technologie - Admin</title>
</svelte:head>
	...
	>
		<div class="form-section">
			<div class="form-group">
				...
				<input type="text" id="name_fr" name="name_fr" required value={data.technology.TEC_NAME.fr} />
			</div>

			<div class="form-group">
				<label for="name_en">Name (EN)</label>
				<input type="text" id="name_en" name="name_en" required value={data.technology.TEC_NAME.en} />
			</div>

			<div class="form-group">
				<label for="slug">Slug</label>
				<input type="text" id="slug" value={data.technology.TEC_SLUG} disabled />
				<p class="help-text">Le slug est généré automatiquement</p>
			</div>
		</div>
