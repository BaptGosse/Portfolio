...
<svelte:head>
	<title>Modifier compétence - Admin</title>
</svelte:head>
	...
	>
		<div class="form-section">
			...
			<div class="form-group">
				...
				<input
					...
					name="context_fr"
					required
					value={data.skill.SKI_CONTEXT.fr}
				/>
			</div>
		</div>
		...
		<div class="form-section">
			...
			<div class="form-group">
				...
				<input
					...
					name="context_en"
					required
					value={data.skill.SKI_CONTEXT.en}
				/>
			</div>
		</div>
		...
		<div class="form-section">
			...
			<div class="form-group">
				...
				<select id="category_id" name="category_id" required>
					{#each data.categories as category}
						<option value={category.CAT_ID} selected={category.CAT_ID === data.skill.CAT_ID}>
							{category.CAT_NAME.fr}
						</option>
					{/each}
				</select>
			</div>
			...
			<div class="form-group">
				...
				<input type="text" id="order" name="order" value={data.skill.SKI_ORDER} />
			</div>
		</div>
